...
import sys
sys.path.append("/users/PYS1027/chnrhughes/work/flowtest/new/code/examples/exp_configs/rl/singleagent/") 
sys.path.append("/users/PYS1027/chnrhughes/work/flowtest/new/code/examples/exp_configs/rl/multiagent/") 
import singleagent_ring
...
#    module_ma = __import__("exp_configs.rl.multiagent", fromlist=[flags.exp_config])
    module = __import__("singleagent_ring")
    module_ma = __import__("multiagent_ring")
    print("module attr ",vars(module))
